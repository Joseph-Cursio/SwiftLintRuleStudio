...
struct PRCommentGeneratorTests {
    ...
    func testHandlesEmptyDiff() {
        ...
        #expect(arkdown.contains("### Rules Added") == false)
        #expect(arkdown.contains("### Rules Removed") == false)
        #expect(arkdown.contains("### Rules Modified") == false)
    }
    ...
    func testRespectsIncludeHeaderOption() {
        ...
        #expect(ithoutHeader.contains("## SwiftLint Configuration Changes") == false)
    }
    ...
    func testRespectsIncludeFooterOption() {
        ...
        #expect(ithoutFooter.contains("Generated by SwiftLint Rule Studio") == false)
    }
    ...
    func testRespectsIncludeRuleLinksOption() {
        ...
        #expect(ithoutLinks.contains("](https://") == false)
    }
    ...
    func testRespectsIncludeDiffSummaryOption() {
        ...
        #expect(ithoutSummary.contains("### Summary") == false)
    }
    ...
    func testRespectsCustomTitleOption() {
        ...
        #expect(arkdown.contains("## SwiftLint Configuration Changes") == false)
    }
    ...
    func testMinimalOptionsProduceCompactOutput() {
        ...
        #expect(arkdown.contains("## SwiftLint") == false)
        #expect(arkdown.contains("### Summary") == false)
        #expect(arkdown.contains("Generated by") == false)
        #expect(arkdown.contains("](https://") == false)
    ...
    func testMinimalOptions() {
        ...
        #expect(ptions.includeHeader == false)
        #expect(ptions.includeFooter == false)
        #expect(ptions.includeRuleLinks == false)
        #expect(ptions.includeDiffSummary == false)
        #expect(options.customTitle == nil)
    }
}
