...
public struct WorkspaceTestHelpers {
    ...
    public static func createValidSwiftWorkspace(
    ...
    public static func cleanupWorkspace(_ url: URL) {
        try? FileManager.default.removeItem(at: url)
    }

    /// Creates a workspace with a .swiftlint.yml config file
    public static func createWorkspaceWithConfig(configContent: String = "") throws -> URL {
    ...
    public static func createWorkspaceWithNestedFiles() throws -> URL {
        let workspace = try createValidSwiftWorkspace()
