...
public struct PRCommentOptions: Sendable {
    public let includeHeader: Bool
    public let includeFooter: Bool
    public let includeRuleLinks: Bool
    public let includeDiffSummary: Bool
...
public class PRCommentGenerator: PRCommentGeneratorProtocol {
    ...
    public func generateMarkdown(from diff: YAMLConfigurationEngine.ConfigDiff) -> String {
    ...
    public func copyToClipboard(_ markdown: String) {
