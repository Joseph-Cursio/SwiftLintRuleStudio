...
public protocol URLConfigFetcherProtocol: Sendable {
...
public enum URLValidationResult: Sendable, Equatable {
    case valid
    case insecureScheme
    case invalidFormat
...
public enum URLConfigFetcherError: LocalizedError, Sendable {
    case invalidURL
    case insecureURL
...
public final class URLConfigFetcher: URLConfigFetcherProtocol, Sendable {
    ...
    public func fetchConfig(from url: URL) async throws -> String {
    ...
    public static func resolveToRawURL(_ url: URL) -> URL {
