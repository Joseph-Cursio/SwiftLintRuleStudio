...
public struct ValidationResult: Sendable {
    ...
    public struct ValidationError: Identifiable, Sendable {
        ...
        public init(field: ConfigField, message: String, suggestion: String? = nil) {
            self.field = field
    ...
    public struct ValidationWarning: Identifiable, Sendable {
        public let id = UUID()
        public let field: ConfigField
        public let message: String
        public let suggestion: String?
    ...
    public enum ConfigField: Hashable, Sendable {
        case rule(String)
...
public class ConfigurationValidator: ConfigurationValidatorProtocol {
    ...
    /// Validate a configuration and return detailed results
    public func validate(_ config: YAMLConfigurationEngine.YAMLConfig) -> ValidationResult {
