...
public struct RulePreset: Identifiable, Codable, Sendable, Equatable {
...
public enum RulePresets {
    ...
    public static let performance = RulePreset(
        id: "performance",
        name: "Performance",
    ...
    public static let swiftUI = RulePreset(
        id: "swiftui",
        name: "SwiftUI",
    ...
    public static let codeStyle = RulePreset(
        id: "code_style",
        name: "Code Style",
    ...
    public static let documentation = RulePreset(
        id: "documentation",
        name: "Documentation",
    ...
    public static var allPresets: [RulePreset] {
        [
            performance,
            swiftUI,
            concurrencySafety,
    ...
    public static func preset(for id: String) -> RulePreset? {
    ...
    public static func presets(in category: RulePreset.PresetCategory) -> [RulePreset] {
    ...
    public static func ruleIds(for presetId: String) -> [String] {
